...
$LANG['en'] = array(
    ...
    'Account'  => 'Account',
    'Prefix will be automatically added to username'  => 'Prefix %s will be automatically added to username',
    ...
    'Prefix will be automatically added to database name and database user'  => 'Prefix  %s will be automatically added to database name and database user.',
    'Database'  => 'Database',
    'Prefix will be automatically added to pod name'  => 'Prefix  %s will be automatically added to pod name.',
    'Pod'  => 'Pod',
    'Type'  => 'Type',
    'Minute'  => 'Minute',
    'Command'  => 'Command',
    ...
    'POD_CREATED_OK'  => 'Pod <a href="/edit/pod/?pod=%s"><b>%s</b></a> has been created successfully.',
    ...
    'DELETE_POD_CONFIRMATION' => 'Are you sure you want to delete pod %s?',
    'SUSPEND_POD_CONFIRMATION' => 'Are you sure you want to suspend pod %s?',
    'UNSUSPEND_POD_CONFIRMATION' => 'Are you sure you want to unsuspend pod %s?',
    ...
    'POD_EXCLUSIONS' => 'Type full pod name, one per line. To exclude all pods use *',
    ...
    'POD_READY' => "Pod has been deployed successfully.\n\nPod: %s\n%s\n\n--\nVesta Control Panel\n",
    ...
    'Current Number Of Pods' => 'Current Number Of Pods',
